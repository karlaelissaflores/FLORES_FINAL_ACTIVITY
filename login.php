...
<div class="container" style="margin-top: 120px";>
  <div class="row">
    <div class="col-md-6 mx-auto">
      <div class="card card-body bg-info mt-5 text-white">
      <h2>Login</h2>
      ...
      <form action="" method="post">
          ...
          <div class="form-row">
            <div class="col">
              <input type="submit" class="btn btn-success text-white btn-block" value="Login">
            </div>
            <div class="col">
              <a href="register.php" class="btn btn-danger btn-block">No account? Register</a>
            </div>
        </div>
      </form>
        </div>
